...
:root {
  ...
  {% set promotion_products_background = settings.promotion_product_colors ? settings.promotion_product_background_color : '' %}
  {% set promotion_products_foreground = settings.promotion_product_colors ? settings.promotion_product_foreground_color : '' %}

  {% set best_seller_products_background = settings.best_seller_product_colors ? settings.best_seller_product_background_color : '' %}
  {% set best_seller_products_foreground = settings.best_seller_product_colors ? settings.best_seller_product_foreground_color : '' %}
