...
<div class="container p-0 px-md-3 position-relative">
    {% if section_title %}
        <h2 class="section-title text-center h3 mb-4">{{ section_title }}</h2>
    {% endif %}
{% if section_without_margins %}
</div>
<div class="container-fluid p-0 overflow-none">
{% endif %}
    ...
    {% if section_slider %}
        ...
        <div class="js-swiper-{{ section_slider_id }} swiper-container">
            <div class="swiper-wrapper {{ section_slider_classes }} row {% if section_without_margins %}no-gutters{% else %}row-grid{% endif %}">
    {% else %}
    ...
    {% for slide in section_banner %}
        ...
        <div class="{% if section_slider %}swiper-slide {% endif %}col-grid {% if section_columns_desktop_4 %}col-md-3{% elseif section_columns_desktop_3 %}col-md-4{% elseif section_columns_desktop_2 %}col-md-6{% elseif section_columns_desktop_1 %}col-md-12{% endif %}">
            <div class="textbanner{% if section_without_margins %} m-0{% endif %}">
                {% if slide.link %}
                ...
                {% endif %}
                {% if has_banner_text %}
                    <div class="textbanner-text{% if section_align_center %} text-center{% endif %} {% if not section_text_outside %} over-image{% endif %} {% if not section_text_outside and slide.color == 'light' %}over-image-invert{% endif %}">
                        {% if slide.title %}
    ...
    {% if section_slider %}
        ...
        {% if section_banner and section_banner is not empty and section_slider_desktop %}
            <div class="js-swiper-{{ section_slider_id }}-prev swiper-button-prev d-none d-md-block svg-icon-text {% if section_without_margins %}swiper-button-opacity{% else %}swiper-button-outside{% endif %}">
                <svg class="icon-inline icon-lg icon-flip-horizontal"><use xlink:href="#chevron"/></svg>
            </div>
            <div class="js-swiper-{{ section_slider_id }}-next swiper-button-next d-none d-md-block svg-icon-text {% if section_without_margins %}swiper-button-opacity{% else %}swiper-button-outside{% endif %}">
